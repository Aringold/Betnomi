...
import { chatMessageSaga, chatLoadParticipant } from './message';
...
export default function* chatSaga() {
  ...
  yield takeEvery(ChatActionTypes.GetUser, chatLoadParticipant);

  yield takeEvery(ChatActionTypes.SendMessage, chatSendMessageSaga);
  yield takeEvery(
