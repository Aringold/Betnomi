      ...
      <div className={styles.contest}>
        ...
        <div className={styles.contestTimer}>
          ...
          <div className={styles.timerTag}>
            ...
            <p className={styles.bitcoinHeading}>
              0.560992
        ...
        <div className={styles.myPosition}>
          <div className={styles.columns}>
            <img className={styles.avatarPosition} src={Avatar} alt="profile" />
          ...
          <div className={styles.columns}>
            ...
            <span className={styles.toReach}>
              top
              <span className={styles.toReachPosition}>10</span>
            </span>
