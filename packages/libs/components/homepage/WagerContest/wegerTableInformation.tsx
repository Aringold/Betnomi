...
export const columns: Column<Data>[] = [
  ...
  },
  {
    ...
    Cell: ({ value }) => (
      <div className={styles.gmaeFlex}>
        <img className={styles.userProfile} src={value.url} alt="user" />
  ...
  },
  {
    ...
    Cell: ({ value }) => (
      <div className={styles.gmaeFlex}>
        <h3 className={styles.headingUsername}>
          $
          {`${value.value}`}
        </h3>
  ...
  },
  {
    ...
    Cell: ({ value }) => (
      <div className={styles.gmaeFlex}>
        <h3 className={value.amount > 0 ? styles.headingBrand : styles.headingButton}>
          {value.amount} 
          {' '}
          <span className={styles.percentageText}>{`(${value.percentage}%)`}</span>
        </h3>
