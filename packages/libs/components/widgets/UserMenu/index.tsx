...
const profileLinks: { link: string; title: string; icon: FontIconName }[] = [
  ...
  {
    link: `${Routes.ProfileRoot}/wallet/deposit`,
    title: 'Deposit',
    icon: FontIconName.Plus,
  },
  {
    link: `${Routes.ProfileRoot}/wallet/withdraw`,
    title: 'Withdraw',
    icon: FontIconName.ArrowRight,
  },
  {
  ...
  { link: `${Routes.ProfileRoot}/settings`, title: 'Settings', icon: FontIconName.Settings },
];
