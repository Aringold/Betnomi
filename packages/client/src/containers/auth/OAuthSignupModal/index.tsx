...
import { authOAuthSignup } from '../../../store/auth/actionCreators';

interface Props extends ModalComponentProps {
}

const OAuthSignupModal: FC<Props> = ({ onCloseModal }) => {
  ...
  const onSend = useCallback(
    (
      ...
      dispatch(authOAuthSignup(values, cb));
    },
