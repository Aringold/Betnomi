...
import { authSignUpWithMetamask } from '../../../store/auth/actionCreators';

interface Props extends ModalComponentProps {
}

const SignUpMetamaskModal: FC<Props> = ({ onCloseModal }) => {
  ...
  const onSend = useCallback(
    (
      ...
      dispatch(authSignUpWithMetamask(values, cb));
    },
