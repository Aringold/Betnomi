...
import { DepositAllFormikValues } from '../../hooks/formik/useDepositAllForm';
...
export const profileSetDepositAll = (
  payload: Partial<ProfileState['depositAll']>,
) => ({
  type: ProfileActionTypes.SetDepositAll,
  payload,
});

export const profileGetDepositAll = (payload: DepositAllFormikValues) => ({
  type: ProfileActionTypes.GetDepositAll,
  payload,
});
...
export const profileSetDepositDetail = (payload: any) => ({
  type: ProfileActionTypes.SetDepositDetail,
  payload,
});
