...
import { setBcCurrencySaga } from './bcCurrency';
import { setUserAvatarSaga, removeUserAvatarSaga } from './avatar';
...
export default function* authSaga() {
  ...
  yield takeLeading(AuthActionTypes.GetGameToken, gameToken);
  yield takeLeading(AuthActionTypes.PutUserAvatar, setUserAvatarSaga);
  yield takeLeading(AuthActionTypes.SetBcCurrency, setBcCurrencySaga);
  yield takeLeading(AuthActionTypes.DelUserAvatar, removeUserAvatarSaga);
}
