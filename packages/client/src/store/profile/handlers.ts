...
const setDepositDetail: ProfileHandlerFn<typeof profileSetDepositDetail> = (
  state,
  { payload },
) => assocPath(['depositAll'], { ...state.depositAll, depositDetail: payload }, state);

const setDepositAll: ProfileHandlerFn<typeof profileSetDepositDetail> = (
  state,
  { payload },
) => assocPath(['depositAll'], { ...state.depositAll, ...payload }, state);
...
export const profileHandlers = {
  ...
  [ProfileActionTypes.SetDepositDetail]: setDepositDetail,
  [ProfileActionTypes.SetDepositAll]: setDepositAll,
};
