...
export const authSetTokens = (access: string, refresh: string, game: any) => ({
...
export const getGameToken = () => ({ type: AuthActionTypes.GetGameToken });
export const setGameToken = (payload: any) => ({
  type: AuthActionTypes.SetGameToken,
  payload,
});
export const setGameTokenFromSocket = (payload: { GameToken: string, ExpiresAt: string }) => ({
  type: AuthActionTypes.SetGameTokenFromSocket,
  payload,
});

export const setBalance = (
  payload: { currency: string, balance: string },
) => ({
  type: AuthActionTypes.SetNewBalance,
  payload,
});

export const uploadUserAvatar = (
  payload: { file: string },
  callback: (e?: AuthErrorTransformResult) => void,
) => ({
  type: AuthActionTypes.PutUserAvatar,
  payload,
  callback,
});
...
export const removeUserAvatar = (
  ...
  type: AuthActionTypes.DelUserAvatar,
  callback,
});
...
export const setUserAvatar = (
  ...
  type: AuthActionTypes.SetUserAvatar,
  payload,
});

export const setBcCurrency = (payload: { bcCurrency: string }) => ({
  type: AuthActionTypes.SetBcCurrency,
  payload,
});
